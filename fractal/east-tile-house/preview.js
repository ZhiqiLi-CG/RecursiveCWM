...
export function build(ctx){const g=new THREE.Group();g.add(network(ctx),baseline(ctx,['east-farmstead']),lamps(ctx),parent(ctx,['east-tile-house']),component(ctx));return g;}
