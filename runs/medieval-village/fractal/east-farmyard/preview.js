...
export function build(ctx){const g=new THREE.Group();g.add(network(ctx),baseline(ctx,['east-farmstead']),lamps(ctx),parent(ctx,['east-farmyard']),component(ctx));return g;}
