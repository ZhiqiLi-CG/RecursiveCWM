...
for n,(u,v) in enumerate([(78,153.5),(129,128),(180,102.5),(231,77)],1):
 ...
 box(q+'foundation',-.30,.065,-.40,.625,.030,.825,'#c654df')
 ...
 roofpatch(q+'roof-main',[(-.30,1.065,.055),(-.30,1.065,-.88),(.16,slope(.16),-.88),(.16,slope(.16),.055)],'#d151e9')
 roofpatch(q+'roof-porch',[(.16,slope(.16),-.35),(.16,slope(.16),-.88),(.32,slope(.32),-.88),(.32,slope(.32),-.35)],'#d151e9')
 ...
 box(q+'front-trim',.006,.32,-.23,.018,.16,.32,'#e3a6c0')
 for k in range(3):box(q+f'front-glass{k}',.018,.32,-.115-k*.10,.012,.095,.080,'#aaa8d0')
 box(q+'door-trim',.009,.265,-.59,.021,.35,.16,'#e2bdaf')
 box(q+'door',.023,.26,-.585,.013,.32,.103,'#796c80')
 ...
 for k,z in enumerate([-.18,-.59]):
  face(q+f'dormer{k}-body',[(.09,slope(.09),z+.11),(.09,1.047,z+.11),(.09,1.047,z-.11),(.09,slope(.09),z-.11)],'#eee2a6')
  for t in [-1,1]:face(q+f'dormer{k}-side{t}',[(-.14,slope(-.14),z+t*.11),(.09,slope(.09),z+t*.11),(.09,1.047,z+t*.11),(-.14,1.136,z+t*.11)],'#e2d18a')
  roofpatch(q+f'dormer{k}-roof',[(-.15,1.144,z+.12),(-.15,1.144,z-.12),(.11,1.043,z-.12),(.11,1.043,z+.12)],'#9623b7')
  box(q+f'dormer{k}-trim',.092,.955,z,.012,.09,.15,'#eab9b7')
  for t in [-1,1]:box(q+f'dormer{k}-glass{t}',.101,.955,z+t*.041,.008,.059,.053,'#c4b8d8')
 box(q+'chimney',-.40,1.055,-.155,.065,.27,.070,['#c9a6cb','#936894','#a57dae'])
