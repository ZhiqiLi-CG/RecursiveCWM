...
for n,(u,v) in enumerate([(78,153.5),(129,128),(180,102.5),(231,77)],1):
 ...
 for k,z in enumerate([-.18,-.59]):
  face(q+f'dormer{k}-body',[(.13,slope(.13),z+.11),(.13,1.067,z+.11),(.13,1.067,z-.11),(.13,slope(.13),z-.11)],'#eee2a6')
  for t in [-1,1]:face(q+f'dormer{k}-side{t}',[(-.10,slope(-.10),z+t*.11),(.13,slope(.13),z+t*.11),(.13,1.067,z+t*.11),(-.10,1.156,z+t*.11)],'#e2d18a')
  roofpatch(q+f'dormer{k}-roof',[(-.11,1.164,z+.12),(-.11,1.164,z-.12),(.15,1.063,z-.12),(.15,1.063,z+.12)],'#9623b7')
  box(q+f'dormer{k}-trim',.132,1.015,z,.012,.09,.15,'#eab9b7')
  for t in [-1,1]:box(q+f'dormer{k}-glass{t}',.141,1.015,z+t*.041,.008,.059,.053,'#c4b8d8')
